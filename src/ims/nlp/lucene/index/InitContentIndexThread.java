...
public class InitContentIndexThread implements Callable<Boolean> {
	...
	public boolean writePostIntoIndex(Map<String, Object> postIndexContentMap) {
		...
		String taskLogId = (String) postIndexContentMap.get("taskLogId");

		try {
			WriteDocIntoIndex.writeSinglePostIntoIndex(content, collectionName,
					postUrlMD5, taskLogId, this.indexAllContentPath,
					this.analyzer);
	...
	public String getIndexAllContentPath() {
		return indexAllContentPath;
	}

	public void setIndexAllContentPath(String indexAllContentPath) {
		this.indexAllContentPath = indexAllContentPath;
	}
