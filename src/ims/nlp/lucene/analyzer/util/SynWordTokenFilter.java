...
public class SynWordTokenFilter extends TokenFilter {
	private CharTermAttribute cta = null;
	private PositionIncrementAttribute pia = null;
	private AttributeSource.State current;
	private Stack<String> sames = null;
	private SynWordContext samewordContext;

	public SynWordTokenFilter(TokenStream input,SynWordContext samewordContext) {
		super(input);
